...
**Goal**: As a user, I want to log in securely, configure encrypted Binance credentials, and have market symbols synced automatically, so that I can safely start using the trading bot on the new, hardened stack.
**Mode:** mvp
...
- [x] 01-08-PLAN.md — Symbol sync slice: atomic transactional sync, empty-table-gated non-blocking boot sync, manual sync endpoint and settings panel
**UI hint**: yes
